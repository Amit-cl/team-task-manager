...
// Register — role is always "member". Admin accounts must be created directly in DB.
router.post("/register", async (req, res) => {
  try {
    ...
    const user = await User.create({ name: name.trim(), email: email.toLowerCase(), password: hashedPassword, role: "member" });
